(() => {
  ...
  (async function run() {
    ...
    stage.id = 'seqStageStack';
    const style = document.createElement('style');
    style.id = 'seqStageStack-style';
    style.textContent = `
    ...
    // --- Auto-clone first image for loop ---
    ...
    // --- Driver (timeline progress + inertia) ---
